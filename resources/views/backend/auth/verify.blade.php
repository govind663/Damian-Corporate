                        ...
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                ...
                                <td style="text-align:center;">
                                    <img width="200" height="120" src="{{ asset('/frontend/assets/img/logo/damian-logo.png') }}" title="Damian Corporate" alt="logo">
                                </td>
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#0634b1; font-size:15px;line-height:24px; margin:0;">
                                            We cannot simply send you your old password. A unique link to reset your
                                            password has been generated for you. To reset your password, click the
                                            following link and follow the instructions.
                                        </p>
                                        <a href="{{ route('admin.password.reset', ['token' => $token]) }}"
                                        style="background:#0d0e0dd4;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reset
                                           Your  Password</a>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">
                                &copy; <strong><a href="{{ route('frontend.home') }}" title="logo" target="_blank">|| Damian Corporate ||</a></strong>
                            </p>
                        </td>
                    </tr>
                    <tr>
