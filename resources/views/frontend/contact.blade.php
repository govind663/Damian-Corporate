...
@section('content')
    ...
    <div class="breadcrumb-section breadcrumb__pt services-breadcrumb"
        style="background-image: url({{ asset('frontend/assets/img/breadcrumbs/contact-breadcrumb.jpg') }}) !important;">
    ...
    <!-- contact area start -->
    <div class="tp-contact-area p-relative fix pt-70 pb-70">
        <div class="container-fluid home-container">
            <div class="row">
                                ...
                                <div class="tp-contact-item d-flex align-items-center">
                                    ...
                                    <div class="tp-contact-content">
                                        ...
                                        <a href="https://maps.app.goo.gl/dScBPHf5xH9zF7fg7" target="_blank"
                                            class="text-white">Damian Corporate Pvt Ltd, Damian House Ground
                                            Floor, 14, Hill Rd, Bandra
                                            West, Mumbai, Maharashtra 400050</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-contact-item d-flex align-items-center">
                                    ...
                                    <div class="tp-contact-content">
                                        ...
                                        <a href="mailto:contact@damiancorporate.com"
                                            class="text-white">contact@damiancorporate.com</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="tp-contact-item d-flex align-items-center">
                                    ...
                                    <div class="tp-contact-content">
                                        ...
                                        <a href="tel:+918433934664" class="text-white">+91-84339 34664</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                                ...
                                <div class="col-lg-12 col-md-12 mb-20">
                                    <div class="tp-contact-input-box">
                                        ...
                                        <div class="tp-contact-icon">
                                            <span>
                                                <img width="17px" src="{{ asset('frontend/assets/img/icon/user.png') }}" /></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 mb-20">
    ...
    <div class="maps-section">
        <!-- service area start -->
        <div class="tp-service-area pt-70 pb-70">
            <div class="container-fluid home-container">
                <div class="row">
