...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('vision.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="image" id="image" class="form-control @error('image') is-invalid @enderror" value="{{old('image')}}" placeholder="Upload Image.">
                ...
                <table class="table table-bordered p-3" id="dynamicCompanyLocationTable">
                    ...
                    <tbody>
                        ...
                        @forelse(old('sub_title', ['']) as $index => $name)
                        <tr>
                            <td>
                                <input type="text" name="sub_title[]" id="sub_title" class="form-control @error('sub_title.' . $index) is-invalid @enderror" value="{{ old('sub_title.' . $index) }}" placeholder="Enter Sub Title">
                                @error('sub_title.' . $index)
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </td>
                            <td>
                                <textarea type="text" style="height: 60px !important" name="sub_description[]" id="sub_description" value="{{ old('sub_description.' . $index) }}" class="form-control @error('sub_description.' . $index) is-invalid @enderror" placeholder="Enter Sub Description">{{ old('sub_description.' . $index) }}</textarea>
