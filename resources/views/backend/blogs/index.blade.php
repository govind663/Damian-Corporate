                ...
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($value->blog_image)
                                    <img src="{{ asset('/damian_corporate/blog/blog_image/' . $value->blog_image) }}" alt="{{ $value->blog_image }}" style="width: 100px; height: auto;">
                                @endif
                            </td>
                            <td>{{ $value->blog_title }}</td>
                            <td>{!! $value->description !!}</td>

                            <td>{{ date( 'd-m-Y H:i:s', strtotime($value->inserted_at) ) }}</td>


                            @if ($value->status == 1)
                                <td class="text-justify"><span class="badge badge-success">Active</span></td>
                            @elseif ($value->status == 2)
                                <td class="text-justify"><span class="badge badge-danger">Inactive</span></td>
                            @endif
