            ...
            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="careers_image" id="careers_image" class="form-control @error('careers_image') is-invalid @enderror" value="{{ old('careers_image') }}">
