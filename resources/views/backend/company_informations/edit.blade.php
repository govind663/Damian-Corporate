...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('companyInformation.update', $company_information->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PATCH')

            <input type="text" id="id" name="id" hidden  value="{{ $company_information->id }}">

            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    <label class="col-sm-2"><b>Company Phone Number : <span class="text-danger">*</span></b></label>
                    <div class="col-sm-4 col-md-4">
                        <input type="text" maxlength="10" name="company_phone" id="company_phone" class="form-control @error('company_phone') is-invalid @enderror" value="{{ $company_information->company_phone }}" placeholder="Enter Company Phone Number.">
                        @error('company_phone')
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="email" name="company_email" id="company_email" class="form-control @error('company_email') is-invalid @enderror" value="{{ $company_information->company_email }}" placeholder="Enter Company Email Id.">
                        @error('company_email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="company_logo" id="company_logo" class="form-control @error('company_logo') is-invalid @enderror" value="{{ $company_information->company_logo }}" placeholder="Upload Company Logo.">
                        ...
                        @if(!empty($company_information->company_logo))
                            <img src="{{ asset('/damian_corporate/company_information/company_logo/' . $company_information->company_logo) }}" alt="Banner Image" style="width: 40%; height: auto; padding:10px;">
                        @endif
                    </div>

                    <label class="col-sm-2"><strong>Company Description :  <span class="text-danger">*</span></strong></label>
                    <div class="col-sm-10 col-md-10">
                        <textarea id="company_description" name="company_description" class="textarea_editor form-control border-radius-0 @error('company_description') is-invalid @enderror" placeholder="Enter Company Description ..." value="{{ $company_information->company_description }}">{{ $company_information->company_description }}</textarea>
...
@php
    $rowIndex = isset($locationNames) ? count($locationNames) : 0;
@endphp
