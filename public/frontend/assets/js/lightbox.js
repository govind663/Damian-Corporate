...
(function (root, factory) {
  ...
  Lightbox.prototype.start = function ($link) {
    ...
    function addToAlbum($link) {
      ...
      var exists = self.album.some(function (item) {
        return item.link === $link.attr('href');
      });
    ...
    // Debug: Check the number of images in the album
    console.log("Number of images in album:", this.album.length);
  ...
  Lightbox.prototype.updateDetails = function () {
    ...
    // Only show the image number label if there's more than one image in the set
