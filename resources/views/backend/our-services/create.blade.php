...
@section('title')
Damian Corporate | Add Our Services
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('our-services.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="service_title" id="service_title" class="form-control @error('service_title') is-invalid @enderror" value="{{old('service_title')}}" placeholder="Enter Title.">
                        @error('service_title')
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="service_image" id="service_image" class="form-control @error('service_image') is-invalid @enderror" value="{{ old('service_image') }}" placeholder="Upload Service Image.">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentServiceLogoPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="service_logo" id="service_logo" class="form-control @error('service_logo') is-invalid @enderror" value="{{ old('service_logo') }}" placeholder="Upload Service Logo.">
                        <small class="text-secondary"><b>Note : The file size  should be less than 2MB .</b></small>
                        <br>
                        <small class="text-secondary"><b>Note : Only files in .jpg, .jpeg, .png, .pdf format can be uploaded .</b></small>
                        <br>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10">
                        <textarea id="service_description" name="service_description" class="textarea_editor form-control border-radius-0 @error('service_description') is-invalid @enderror" placeholder="Enter Description ..." value="{{ old('service_description') }}">{{ old('service_description') }}</textarea>
