...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('awards-media.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="award_image" id="award_image" class="form-control @error('award_image') is-invalid @enderror" value="{{ old('award_image') }}" placeholder="Upload Award & Media Image.">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" maxlength="4" name="year" id="year" class="form-control @error('year') is-invalid @enderror" value="{{old('year')}}" placeholder="Enter Year.">
                        @error('year')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
