...
class ProductCategoryController extends Controller
{
    ...
    {
        $categories = ProductCategory::orderBy("id","desc")->whereNull('deleted_at')->get();
    ...
    public function store(ProductCategoryRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('product-category.index')->with('message','Product Category has been successfully created.');
