                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0; font-size:25px; font-family:Averta-Regular !important;">
                                            Send Subscribe Us Mail
                                        </h1>
                                        ...
                                        <p class="details" style="color:#44474d; font-size:18px;line-height:24px; margin:0; text-align: justify;">
                                            Thank you for subscribing to Damian Corporate! Stay connected for the latest updates, exclusive offers,
                                            and insights tailored for you. We value your interest in our journey!
                                        </p>
