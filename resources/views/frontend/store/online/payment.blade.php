...
<body>
    <div class="grid-container">
        ...
        <div class="form-container">
            ...
            <hr>
            <form method="POST" action="{{ route('frontend.payment.process') }}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="main-form">
                    ...
                    <div class="row mandatory-data">
                        ...
                        <div class="form-field">
                            ...
                            <input id="amount" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ number_format(old('amount') ?? $amount, 2) }}" readonly placeholder="125.25">
                            @error('amount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-field">
                            ...
                            <input id="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" readonly value="{{ Auth::guard('citizen')->user()->phone }}" placeholder="0123456789">
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-field">
                            ...
                            <input id="productinfo" class="form-control @error('productinfo') is-invalid @enderror" name="productinfo" readonly value="{{ $product->name }}" placeholder="Product Info">
                            @error('productinfo')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="optional-data">
                        ...
                        <div class="form-field">
                            ...
                            <input id="city" class="city" name="city" value="{{ old('city') ? old('city') : Auth::guard('citizen')->user()->city }}" readonly placeholder="Pune">
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input id="stateId" class="state" name="stateId" value="{{ old('state') ? old('state') : $state }}" readonly placeholder="Maharashtra">
                        </div>
