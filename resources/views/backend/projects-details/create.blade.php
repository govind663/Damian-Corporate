...
@section('title')
Damian Corporate | Add Project Details
@endsection
        ...
        <form method="POST" action="{{ route('project-details.store') }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="location_url" id="location_url" class="form-control @error('location_url') is-invalid @enderror" value="{{ old('location_url') }}" placeholder="Enter Project Location Link.">
                        @error('location_url')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="total_constructed_area" id="total_constructed_area" class="form-control @error('total_constructed_area') is-invalid @enderror" value="{{ old('total_constructed_area') }}" placeholder="Enter Total Constructed Area.">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <textarea name="project_description" id="project_description" class="form-control textarea_editor border-radius-0 @error('project_description') is-invalid @enderror" rows="4" placeholder="Enter the Project Description here.">{{ old('project_description') }}</textarea>
...
<script>
    $(document).ready(function () {
        ...
        let oldBannerImages = @json(old('banner_image', []));
