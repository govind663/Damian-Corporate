...
@section('title')
Damian Corporate | Edit Product Category
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('product-category.update', $category->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
