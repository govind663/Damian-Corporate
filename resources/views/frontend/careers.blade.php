                                ...
                                <div class="accordion-items tp-faq-active">
                                    ...
                                    <div id="collapse{{ $key }}" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            @if (!empty($value->requirements) && is_array($value->requirements) && count($value->requirements) > 0)
                                                <p class="pt-30">
                                                    <b>Requirement :</b>
                                                </p>
                                                <div class="tp-about-list pb-30">
                                            ...
                                            @if (!empty($value->qualification) && is_array($value->qualification) && count($value->qualification) > 0)
                                                <p class="pt-30">
                                                    <b> Qualification :</b>
                                                </p>
                                                <div class="tp-about-list pb-30">
                                            ...
                                            @if (!empty($value->salary) && is_array($value->salary) && count($value->salary) > 0)
                                                <p class="pt-30">
                                                    <b>CTC :</b>
                                                </p>
