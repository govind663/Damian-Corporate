...
@section('title')
Damian Corporate | Manaage Project Details
@endsection
                ...
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">{{ $value->project->project_name }}</td>

                            <td class="text-wrap text-justify">{{ $value->slug }}</td>

                            <td class="text-wrap text-justify">{{ $value->location }}</td>

                            <td class="text-wrap text-justify">{{ $value->total_constructed_area }}</td>
