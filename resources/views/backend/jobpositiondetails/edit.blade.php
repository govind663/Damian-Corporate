        ...
        <form method="POST" action="{{ route('job-position-details.update', $jobpositiondetails->id) }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <label class="col-sm-2"><b>Responsibilities : </b></label>
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="job_location" id="job_location" class="form-control @error('job_location') is-invalid @enderror" value="{{ $jobpositiondetails->job_location }}" placeholder="Enter Project Location Link.">
                        @error('job_location')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
